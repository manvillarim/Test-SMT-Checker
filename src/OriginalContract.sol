...
// Esse contrato é um ERC20 com adição de controle de propriedade, pausabilidade, vesting, taxa de trasferência, etc
// Tem uma falha de reentrância intencional na função withdraw, visando analisar a capacidade do smt checker
// O SMT não consegue achar o erro
// Meta: simplificar o contrato sem alteração semântica para o smt funcionar
